// lib/src/core/design_system/theme/app_text_theme.dart
...
abstract class FontStyles {
  ...
  static const TextStyle reg20 = TextStyle(
    fontSize: 20,
    fontFamily: _fontFamily,
    fontWeight: FontWeight.w400,
    letterSpacing: -0.32,
  );
  static const TextStyle reg18 = TextStyle(
    fontSize: 18,
    fontFamily: _fontFamily,
    fontWeight: FontWeight.w400,
    letterSpacing: -0.32,
  );
  static const TextStyle reg16 = TextStyle(
    fontSize: 16,
    fontFamily: _fontFamily,
    fontWeight: FontWeight.w400,
    letterSpacing: -0.32,
  ...
  static const TextStyle reg14 = TextStyle(
    fontSize: 14,
    fontFamily: _fontFamily,
    fontWeight: FontWeight.w400,
    letterSpacing: -0.32,
  );
  static const TextStyle reg12 = TextStyle(
    fontSize: 12,
    fontFamily: _fontFamily,
    fontWeight: FontWeight.w400,
    letterSpacing: -0.32,
