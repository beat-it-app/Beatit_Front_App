...
mixin _$ResetPasswordRequest {
 ...
 String get identifier; String get email; String get newPassword;
...
@useResult
$Res call({
 String identifier, String email, String newPassword
});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? identifier = null,Object? email = null,Object? newPassword = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String identifier,  String email,  String newPassword)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.identifier,_that.email,_that.newPassword);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String identifier,  String email,  String newPassword)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest():
return $default(_that.identifier,_that.email,_that.newPassword);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String identifier,  String email,  String newPassword)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.identifier,_that.email,_that.newPassword);case _:
  return null;
...
class _ResetPasswordRequest implements ResetPasswordRequest {
  const _ResetPasswordRequest({required this.identifier, required this.email, required this.newPassword});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? identifier = null,Object? email = null,Object? newPassword = null,}) {
