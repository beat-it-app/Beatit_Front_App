...
mixin _$SignupRequest {
 ...
 String get identifier; String get password; String get email;
...
@useResult
$Res call({
 String identifier, String password, String email
});
...
/// Create a copy of SignupRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? identifier = null,Object? password = null,Object? email = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String identifier,  String password,  String email)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignupRequest() when $default != null:
return $default(_that.identifier,_that.password,_that.email);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String identifier,  String password,  String email)  $default,) {final _that = this;
switch (_that) {
case _SignupRequest():
return $default(_that.identifier,_that.password,_that.email);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String identifier,  String password,  String email)?  $default,) {final _that = this;
switch (_that) {
case _SignupRequest() when $default != null:
return $default(_that.identifier,_that.password,_that.email);case _:
  return null;
...
class _SignupRequest implements SignupRequest {
  const _SignupRequest({required this.identifier, required this.password, required this.email});
...
/// Create a copy of SignupRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? identifier = null,Object? password = null,Object? email = null,}) {
