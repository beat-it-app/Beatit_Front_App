...
mixin _$AuthSession {
 ...
 int get userId; Role get role; bool get createdProfile; String get accessToken; SocialProvider? get socialProvider;
...
@useResult
$Res call({
 int userId, Role role, bool createdProfile, String accessToken, SocialProvider? socialProvider
});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? role = null,Object? createdProfile = null,Object? accessToken = null,Object? socialProvider = freezed,}) {
...
as String,socialProvider: freezed == socialProvider ? _self.socialProvider : socialProvider // ignore: cast_nullable_to_non_nullable
as SocialProvider?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  Role role,  bool createdProfile,  String accessToken,  SocialProvider? socialProvider)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.userId,_that.role,_that.createdProfile,_that.accessToken,_that.socialProvider);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  Role role,  bool createdProfile,  String accessToken,  SocialProvider? socialProvider)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.userId,_that.role,_that.createdProfile,_that.accessToken,_that.socialProvider);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  Role role,  bool createdProfile,  String accessToken,  SocialProvider? socialProvider)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.userId,_that.role,_that.createdProfile,_that.accessToken,_that.socialProvider);case _:
  return null;
...
class _AuthSession implements AuthSession {
  const _AuthSession({required this.userId, required this.role, required this.createdProfile, required this.accessToken, this.socialProvider});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? role = null,Object? createdProfile = null,Object? accessToken = null,Object? socialProvider = freezed,}) {
