...
@override
String toString() {
  return 'LoginResponse(userId: $userId, role: $role, createdProfile: $createdProfile, socialProvider: $socialProvider)';
}
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.userId, required this.role, required this.createdProfile, this.socialProvider});
